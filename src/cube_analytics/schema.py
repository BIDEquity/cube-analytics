...
class ColumnMapping:
    ...
    Attributes:
        ...
        cohort: Optional acquisition cohort column (tenant-specific, enables Segments tab)
        pricing_segment: Optional pricing segment column (tenant-specific, enables Segments tab)
